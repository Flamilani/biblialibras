...
class Sobre extends CI_Controller {
    ...
    if ($this->form_validation->run() == false) {
            ...
            if ($this->sobre_model->adicionarSobre($titulo, $conteudo, $midia, $imagem, $video, $status)) {
   ...
   public function gravar_alteracoes() {
    ...
    if ($this->form_validation->run() == false) {
            ...
            if ($this->sobre_model->gravar_alteracoes($id, $titulo, $conteudo, $midia, $imagem, $video, $status)) {
                $this->session->set_flashdata("success", "A página Sobre foi atualizada com sucesso.");
                redirect(base_url('admin/sobre'));
            } else {
                echo "Erro ao cadastrar a página";
