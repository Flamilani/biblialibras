...
class Suspensao extends CI_Controller {
    ...
    public function index() {
        ...
        $data['suspensao'] = $this->suspensao_model->admin_Suspensao();
        ...
        $this->load->view('admin/suspensao', $data);
        $this->load->view('admin/inc/footer');
        $this->load->view('admin/inc/html-footer');

    }

    public function gravarSuspensao() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $inicial = $this->input->post('data_inicial');
            $final = $this->input->post('data_final');
            ...
            if ($this->suspensao_model->adicionarSuspensao($titulo, $conteudo, $inicial, $final, $status)) {
                $this->session->set_flashdata("success", "A suspensão foi atualizada com sucesso.");
                redirect(base_url('admin/suspensao'));
            } else {
    ...
    public function gravar_alteracoes() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $id = $this->input->post('id_suspensao');
            ...
            if ($this->suspensao_model->gravar_alteracoes($id, $titulo, $conteudo, $inicial, $final, $status)) {
                $this->session->set_flashdata("success", "A suspensão foi atualizada com sucesso.");
                redirect(base_url('admin/suspensao'));
            } else {
