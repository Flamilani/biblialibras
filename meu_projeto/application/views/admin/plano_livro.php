<div id="page-wrapper">
    ...
    <?php $countPLivro = $rowsPlanoLivro->result(); ?> 
            ...
            <!-- /.row -->
                        ...
                        <!-- /.row -->
                <?php if($this->session->flashdata('alterar')) { ?>
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                     ...
                     Editar Livro do Plano 
                        </div>
                        <div class="panel-body">
  <?php $buttonPubl = array('name' => 'btn_publicar', 'id' => 'btn_publicar', 'type' => 'submit', 'class' => 'btn btn-success', 'value' => 'Atualizar'); ?>
            ...
            <?php echo form_open('admin/planos/alterarPlanoLivro', 'role="form"'); ?>
              ...
              <?php echo form_hidden('id_plano_livro', $plano_livro[0]->id_plano_livro) ?>
                     ...
                     <div class="col-md-6">
                      ...
                      <div class="checkbox">
     <label><input type="checkbox" name="livros[]" value="<?php echo $livro->id_livro; ?>" id="<?php echo $livro->id_livro; ?>" <?php echo (in_array($livro->id_livro, explode(',', $plano_livro[0]->params))) ? 'checked="checked"' : ''; ?> />
                     <?php echo $livro->ordem; ?> - <b><?php echo $livro->titulo; ?></b>
     </label>       
                      </div>
                     <?php endforeach; ?> 
 ...
 <?php foreach($resplLivro as $pl): ?>
  ...
  <?php echo (in_array($pl->id_livro, explode(',', $plano_livro[0]->params))) ? $pl->titulo . "<br/>" : ''; ?>
                     <?php endforeach; ?> 
<?php echo $plano_livro[0]->params; ?>
<?php echo count(array($plano_livro[0]->params)); ?>   -->    
                            <!-- /.row (nested) -->
                        </div>
                        <!-- /.panel-body -->
                    </div>
