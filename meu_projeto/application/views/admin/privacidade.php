<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-lg-12">
            <h3 class="page-header">Página Política de Privacidade</h3>

        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <?php if(isset($privacidade[0]->id_privacidade) && $privacidade[0]->id_privacidade != null && $privacidade[0]->id_privacidade != ''): ?>
        <?php if($this->session->flashdata('success')) { ?>
            <div class="alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <i class="icon fa fa-success"></i>A página Privacidade foi atualizada com sucesso!</div>
        <?php } else if($this->session->flashdata('deletar')) { ?>
            <div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <i class="icon fa fa-success"></i>A página Privacidade foi deletada com sucesso!</div>
        <?php } ?>
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        Atualizar Página Política de Privacidade <b style="font-size: 15px;" class="pull-right label <?php echo ($privacidade[0]->status) ? 'label-success' : 'label-warning' ?>"><?php echo ($privacidade[0]->status) ? 'Ativo' : 'Inativo' ?></b>
                    </div>
                    <div class="panel-body">
                        <?php $titulo = array('name' => 'titulo', 'id' => 'titulo', 'type' => 'text', 'titulo', 'value' => $privacidade[0]->titulo, 'class' => 'form-control', 'placeholder' => 'Título');
                        $conteudo = array('name' => 'editor1', 'type' => 'text', 'id' => 'editor1', 'value' => $privacidade[0]->conteudo, 'class' => 'form-control', 'rows' => '3');
                        ...
                        <?php echo form_open('admin/privacidade/gravar_alteracoes') . form_hidden('id_privacidade',$privacidade[0]->id_privacidade); ?>
                        <div class="row">
                            <div class="col-md-6">
    ...
    <?php else: ?>
        <?php if($this->session->flashdata('success')) { ?>
            <div class="alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <i class="icon fa fa-success"></i>A página Privacidade foi adicionada com sucesso!</div>
        <?php } else if($this->session->flashdata('deletar')) { ?>
            <div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <i class="icon fa fa-success"></i>A página Privacidade foi deletada com sucesso!</div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        Configurar Página Política de Privacidade
                    </div>
                    <div class="panel-body">
                        ...
                        <?php echo form_open('admin/privacidade/gravarPrivacidade', 'role="form"'); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo form_label('Título', 'titulo') . form_input($titulo); ?>
