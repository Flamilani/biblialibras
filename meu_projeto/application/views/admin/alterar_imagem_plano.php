<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><a href="<?php echo base_url("admin/plano") ?>">Planos</a> > Imagem de <?php echo $plano[0]->titulo; ?> - ID <?php echo $plano[0]->id_plano; ?></h3> 

                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
             <?php if(isset($plano[0]->imagem) && $plano[0]->imagem != null): ?>
     ...
     <?php echo form_open_multipart('admin/plano/gravar_imagem') . form_hidden('id_plano',$plano[0]->id_plano); ?>
      <div class="row">
                               
                                    <input name="titulo" class="form-control" type="hidden" value="<?php echo $plano[0]->titulo; ?>" />
        ...
        <div class="panel panel-default">
              ...
              <div class="panel-body">
   <img class="exibeImg imgNormal" src="<?php echo base_url('assets/uploads/' . $plano[0]->imagem); ?>" id="img_upload" alt="" />  
       </div>   
     </div>  
                               </div>
                           </div>
