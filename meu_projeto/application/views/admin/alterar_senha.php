<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                     <h3 class="page-header"><a href="<?php echo base_url("admin/usuarios") ?>">Usuários</a> > <a href="<?php echo base_url("admin/usuarios/perfil/" . $perfil[0]->id) ?>"> Perfil</a>: <?php echo $perfil[0]->nome; ?> <?php echo $perfil[0]->sobrenome; ?> - ID <?php echo zerofill($perfil[0]->id); ?></h3> 
...
<?php $senha = array('id' => 'inputPassword', 'type' => 'password', 'class' => 'form-control', 'placeholder' => 'Digite sua senha', 'data-error' => 'Mínimo de seis (6) dígitos.', 'pattern' => '.{6,12}', 'title' => 'Informe sua Senha [de 6 a 12 caracteres!]','required' => 'required');
   $confsenha = array('name' => 'senha','id' => 'inputConfirm', 'type' => 'password', 'class' => 'form-control', 'placeholder' => 'Confirme sua senha', 'data-match' => '#inputPassword','data-match-error'=>'As senhas não são iguais.','required' => 'required');
     ...
     <?php echo form_open('admin/usuarios/alterar_senha_user', array('id'=>'SendSenha')) . form_hidden('id', $perfil[0]->id); ?>
                             <div class="row">
                              <div class="col-md-6">
