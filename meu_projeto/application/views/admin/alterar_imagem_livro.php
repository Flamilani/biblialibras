<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><a href="<?php echo base_url("admin/livros") ?>">Livros</a> > Imagem de <?php echo $livro[0]->titulo; ?> - ID <?php echo $livro[0]->id_livro; ?></h3> 
     ...
     <?php echo form_open_multipart('admin/livros/gravar_imagem') . form_hidden('id_livro',$livro[0]->id_livro); ?>
      <div class="row">
