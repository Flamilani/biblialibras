...
<div id="page-wrapper">
            <div class="row">
                     <div class="col-lg-12">
                    <h3 class="tituloCima"><a href="<?php echo base_url('area'); ?>">Área do Usuário</a> > Pagamento do <?php echo $comprovante[0]->nome; ?> <?php echo $comprovante[0]->sobrenome; ?> (<?php echo $comprovante[0]->nome_plano; ?> - <?php echo $comprovante[0]->duracao; ?> <?php echo FormPeriodo($comprovante[0]->periodo); ?>)</h3>
     ...
     <?php echo form_open_multipart('area/gravar_comprovante') . form_hidden('id_pago',$comprovante[0]->id_pago) . form_hidden('id_plano',$comprovante[0]->id_plano); ?>
      <div class="row">
